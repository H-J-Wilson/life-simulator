...
#12082026 Harry added code to his new dashboard
...
def planes():
    ...
    for a in aircraft_data["aircraft"]:
        ...
        if hex:
            print(
                "ID: {hex} Flt: {flight} Desc: {desc} Speed: {tas}Ks Altitude: {alt_geom}Ft Distance: {r_dst}Nm Bearing: {r_dir}Deg".format(
                    hex=hex,
                    flight=flight,
                    desc=desc,
                    tas=tas,
